...
SIMSNORMALDFPREREQ=$(SIMSNORMALRENYIRESIDDF) $(SIMSNORMALRENYIDF) \
...
SIMSGARCHDFPREREQ=$(SIMSGARCHRENYIRESIDDF) $(SIMSGARCHRENYIDF) \
				  $(SIMSGARCHCUSUMDF) $(SIMSGARCHHSDF)
SIMSGARCHDF=data/SimsGARCH.Rda
SIMSGARCHHETERODFPREREQ=$(SIMSGARCHHETERORENYINDF) \
				        $(SIMSGARCHHETERORENYIRESIDDF) \
