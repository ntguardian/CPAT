...
# Curtis Miller
################################################################################
# Structural change context where change occurs at a proportional location in
# the sample.
################################################################################
...
main <- function(output = "ContextPropChange.R", help = FALSE) {
  ...
  kstar_functions <- c("c10thprop" = function(n) {ceiling(n / 10)})
