...
main <- function(output = "SimTestCUSUMAlt.Rda", linetype = "longdash",
                 help = FALSE) {
  ...
  cusum_st <- function(formula, data) {
    ...
    CPAT:::stat_Vn(res, use_kernel_var = TRUE, kernel = "ba", bandwidth = function(n) {1.3 * sqrt(n)})
  }
