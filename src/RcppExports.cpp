...
// get_lrv_vec_cpp
NumericVector get_lrv_vec_cpp(const NumericVector& X, const NumericVector& kern, const unsigned int& max_l);
RcppExport SEXP _CPAT_get_lrv_vec_cpp(SEXP XSEXP, SEXP kernSEXP, SEXP max_lSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector& >::type X(XSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type kern(kernSEXP);
    Rcpp::traits::input_parameter< const unsigned int& >::type max_l(max_lSEXP);
    rcpp_result_gen = Rcpp::wrap(get_lrv_vec_cpp(X, kern, max_l));
    return rcpp_result_gen;
END_RCPP
}
// get_lrv_vec_old1_cpp
NumericVector get_lrv_vec_old1_cpp(const NumericMatrix& Y, const NumericVector& kern, const int& max_l);
RcppExport SEXP _CPAT_get_lrv_vec_old1_cpp(SEXP YSEXP, SEXP kernSEXP, SEXP max_lSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(get_lrv_vec_old1_cpp(Y, kern, max_l));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CPAT_get_lrv_vec_old1_cpp", (DL_FUNC) &_CPAT_get_lrv_vec_old1_cpp, 3},
