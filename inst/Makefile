...
ALLSIMS=$(SIMSNORMALRENYI) $(SIMSNORMALRENYIRESID) $(SIMSNORMALRENYINOKERN) \
        ...
        $(SIMSNORMALHETEROCUSUM) $(SIMSNORMALHETEROHS) $(SIMSPROPNORMALRENYI) \
        $(SIMSPROPNORMALRENYIRESID) $(SIMSPROPNORMALRENYINOKERN) \
        $(SIMSPROPNORMALCUSUM) $(SIMSPROPNORMALHS) \
        $(SIMSPROPNORMALHETERORENYI) $(SIMSPROPNORMALHETERORENYIRESID) \
        $(SIMSPROPNORMALHETERORENYINOKERN) $(SIMSPROPNORMALHETEROCUSUM) \
        $(SIMSPROPNORMALHETEROHS) $(SIMSARMARENYI) $(SIMSARMARENYIRESID) \
        $(SIMSARMACUSUM) $(SIMSARMAHS) $(SIMSARMAHETERORENYI) \
        $(SIMSARMAHETERORENYIRESID) $(SIMSARMAHETEROCUSUM) $(SIMSARMAHETEROHS) \
        $(SIMSGARCHRENYI) $(SIMSGARCHRENYIRESID) $(SIMSGARCHRENYINOKERN) \
        $(SIMSGARCHCUSUM) $(SIMSGARCHHS) $(SIMSGARCHHETERORENYI) \
...
SIMSPROPNORMALDFPREREQ=$(SIMSPROPNORMALRENYIDF) $(SIMSPROPNORMALRENYIRESIDDF) \
                       $(SIMSPROPNORMALRENYINOKERNDF) $(SIMSPROPNORMALCUSUMDF) \
                       $(SIMSPROPNORMALHSDF)
SIMSPROPNORMALDF=data/SimsPropNormal.Rda
SIMSPROPNORMALHETERODFPREREQ=$(SIMSPROPNORMALHETERORENYIDF) \
                             $(SIMSPROPNORMALHETERORENYIRESIDDF) \
...
POWERPLOTPROPNORMALHETEROPREFIX=$(POWERPLOTPREFIX)prop_norm_hetero
